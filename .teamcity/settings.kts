...
elhubProject(DEVXP, "devxp-lint-configuration") {
    pipeline {
        sequential {
            val prepareDotfilesForSonarScanJob = prepareDotfilesForSonarScan()
            ...
            makeVerify {
                ...
                sonarScanSettings = {
                    ...
                    additionalParams =
                        mutableListOf(
                            ...
                            "-Dsonar.lang.patterns.json=**/*.json,**/jsonlintrc",
                ...
                this.buildType.dependencies {
                    artifacts(buildTypeId = prepareDotfilesForSonarScanJob.id) {
...
fun PipelineScope.prepareDotfilesForSonarScan(): VerifyArtifacts = customJob(
